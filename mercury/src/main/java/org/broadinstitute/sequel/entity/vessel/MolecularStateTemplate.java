 ...
 * when a {@link org.broadinstitute.sequel.entity.labevent.LabEvent} is going to result in
 ...
 * during a {@link org.broadinstitute.sequel.entity.labevent.LabEvent}, it doesn't matter
 * that the event is happening out of order.  For
 * example, doing a straight transfer.  The
 * {@link org.broadinstitute.sequel.entity.labevent.LabEvent#getSourceLabVessels() sources}
 * and {@link org.broadinstitute.sequel.entity.labevent.LabEvent#getTargetLabVessels() targets}
 * share the same {@link org.broadinstitute.sequel.entity.sample.SampleSheet}.
 * 
 ...
 * 
 * Recall that if we think that a {@link org.broadinstitute.sequel.entity.labevent.LabEvent} is
 * going to mangle the {@link MolecularState} of something,
 * we'll send out advisory notes (email, jira, etc.),
 * fail to set the {@link org.broadinstitute.sequel.entity.sample.SampleInstance sample metadata} for
 * {@link org.broadinstitute.sequel.entity.labevent.LabEvent#getTargetLabVessels() targets of an event},

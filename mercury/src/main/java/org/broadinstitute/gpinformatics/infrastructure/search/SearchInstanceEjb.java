...
public class SearchInstanceEjb {
    ...
    static {
        ...
        mapTypeToPreferenceAccess.put(PreferenceType.USER_QUEUE_GROUPING_SEARCH_INSTANCES, new PreferenceAccess() {
            @Override
            public List<Preference> getPreferences(Long userID, PreferenceDao preferenceDao) throws Exception {
                return preferenceDao.getPreferences(userID, PreferenceType.USER_QUEUE_GROUPING_SEARCH_INSTANCES);
            }

            @Override
            public Preference createNewPreference(Long userID) {
                return new Preference(userID, PreferenceType.USER_QUEUE_GROUPING_SEARCH_INSTANCES, "");
            }
        ...
        mapTypeToPreferenceAccess.put(PreferenceType.GLOBAL_QUEUE_GROUPING_SEARCH_INSTANCES, new PreferenceAccess() {
            @Override
            public List<Preference> getPreferences(Long userID, PreferenceDao preferenceDao) throws Exception {
                List<Preference> preferences = new ArrayList<>();
                Preference preference =  preferenceDao.getGlobalPreference(PreferenceType.GLOBAL_QUEUE_GROUPING_SEARCH_INSTANCES);
                if( preference != null ) {
                    preferences.add(preference);
                }
                return preferences;
            ...
            @Override
            public Preference createNewPreference(Long userID) {
                return new Preference(userID, PreferenceType.GLOBAL_QUEUE_GROUPING_SEARCH_INSTANCES, "");
            }

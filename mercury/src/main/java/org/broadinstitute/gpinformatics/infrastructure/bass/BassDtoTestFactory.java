...
public class BassDtoTestFactory {
    public static BassDTO buildBassResults(String project, String sample, String version, String rpid, String dataType) {
        Map<BassDTO.BassResultColumn, String> resultsMap = new HashMap<>();
        resultsMap.put(BassDTO.BassResultColumn.sample, sample);
        resultsMap.put(BassDTO.BassResultColumn.datatype, dataType);

...
public class BaseSplitter {
    ...
    public static <T> List<Collection<T>> split(Collection<T> collection, int size) {
        ...
        List<Collection<T>> result = new ArrayList<Collection<T>>(collection.size() / size);
        ...
        if (collection instanceof List) {
            ...
            // Each chunk is here
            Collection<T> temp = new ArrayList<T>(size);
    ...
    public static <T> List<T[]> split(T[] array, int size) {
        ...
        // The full split up results
        List<T[]> result = new ArrayList<T[]>(array.length / size);

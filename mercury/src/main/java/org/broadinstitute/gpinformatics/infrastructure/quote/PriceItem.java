...
public class PriceItem {
    ...
    public boolean equals(Object o) {
        ...
        if (platformName != null ? !platformName.equals(priceItem.platformName) : priceItem.platformName != null) return false;
        if (price != null ? !price.equals(priceItem.price) : priceItem.price != null) return false;
        if (unit != null ? !unit.equals(priceItem.unit) : priceItem.unit != null) return false;

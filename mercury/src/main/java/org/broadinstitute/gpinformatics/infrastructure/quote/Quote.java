...
public class Quote {
    ...
    /**
     * Determines whether or not the funding level has only one funding source to it.
     *
     * @return true if there is only one funding source associated with the quote
     */

...
@DiscriminatorValue("TOTALDNA")
public class TotalDNARiskCriteria extends RiskCriteria {
    ...
    public TotalDNARiskCriteria() {
    }

    public TotalDNARiskCriteria(@Nonnull String name, @Nonnull NumericOperator numericOperator, @Nonnull Double value) {
        super(name);
    ...
    public boolean onRisk(ProductOrderSample sample) {
        ...
        if ((sample != null) && (sample.getBspDTO() != null)) {
            onRiskStatus = numericOperator.apply(sample.getBspDTO().getTotal(), value);
        }
        return onRiskStatus;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TotalDNARiskCriteria)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
        ...
        final TotalDNARiskCriteria that = (TotalDNARiskCriteria) o;

...
public class ResearchProject implements Serializable {
    ...
    public void submit () throws IOException {
        ...
        if ( !piList.toString ().isEmpty () ) {
            listOfFields.add ( new CustomField ( submissionFields, RequiredSubmissionFields.BROAD_PIS,
                                                 piList.toString () ) );
        }
        ...
        JiraIssue issue = jiraService.createIssue ( fetchJiraProject ().getKeyPrefix (), username,

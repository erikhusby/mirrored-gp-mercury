...
public class IndexedPlateFactory {
    ...
    public enum TechnologiesAndParsers {
        FOUR54_SINGLE("454 (Single Index, 4-Column Format)",
                new IndexedPlateParserFourColumnFormat(MolecularIndexingScheme.IndexPosition.FOUR54_A.getTechnology()),
                false),
        ION_SINGLE("Ion Torrent (Single Index, 4-Column Format)",
                new IndexedPlateParserFourColumnFormat(MolecularIndexingScheme.IndexPosition.ION_A.getTechnology()),
                false),
        ILLUMINA_SINGLE("Illumina (Single Index, 4-Column Format)",
                new IndexedPlateParserFourColumnFormat(MolecularIndexingScheme.IndexPosition.ILLUMINA_P7.getTechnology()),
                false),
        ILLUMINA_IDT_P7("Illumina (Single Index P7, IDT Format)",
                new IndexedPlateParserIDTSpreadsheetFormat(MolecularIndexingScheme.IndexPosition.ILLUMINA_P7),
                true),
        ILLUMINA_IDT_P5("Illumina (Single Index P5, IDT Format)",
                new IndexedPlateParserP5SpreadsheetFormat(MolecularIndexingScheme.IndexPosition.ILLUMINA_P5),
                true),

...
//    }
     ...
     */
    void startWithTube(TwoDBarcodedTube receptacle, Graph graph, List<AlternativeId> alternativeIds) {
        if (receptacle == null) {
...
//            System.out.println("Rendering plate " + plate.getBarcode());
    ...
    private int renderReceptacleEdges(Receptacle receptacle, Graph graph, Queue<Vessel> vesselQueue, List<AlternativeId> alternativeIds) {
...
//            System.out.println("Rendering receptacle " + receptacle.getBarcode());
    ...
    private Map<String, List<String>> getAlternativeIds(
            Receptacle receptacle, List<AlternativeId> alternativeIdList) {

...
public class Metadata {
    ...
    public enum Key implements Displayable {
        ...
        PARENT_SAMPLE_ID(Category.SAMPLE, DataType.STRING, "Parent Sample ID", Visibility.USER),
        ...
        AGE(Category.SAMPLE, DataType.STRING, "Age", Visibility.USER),
        CONTACT(Category.SAMPLE, DataType.STRING, "Contact", Visibility.USER),
        EMAIL(Category.SAMPLE, DataType.STRING, "Email", Visibility.USER),
        TEST_NAME(Category.SAMPLE, DataType.STRING, "Test Name", Visibility.USER),
        ;

...
/**
 * Utility class to map from Mercury JAXB DTOs (classes in {@link org.broadinstitute.gpinformatics.mercury.boundary}) to their
 * Squid equivalents (classes in {@link org.broadinstitute.gpinformatics.mercury.boundary.squid}).
 *
 */
public class ToSquid {

    public static Organism squidify(org.broadinstitute.gpinformatics.mercury.boundary.Organism organism) {
    ...
    public static BaitSet squidify(org.broadinstitute.gpinformatics.mercury.boundary.BaitSet baitSet) {
    ...
    public static ReferenceSequence squidify(org.broadinstitute.gpinformatics.mercury.boundary.ReferenceSequence referenceSequence) {
    ...
    public static AbstractPass squidify(org.broadinstitute.gpinformatics.mercury.boundary.AbstractPass sequelPass) {
        AbstractPass ret;


        if (sequelPass instanceof org.broadinstitute.gpinformatics.mercury.boundary.WholeGenomePass) {
            ret = new WholeGenomePass();
        }
        else if (sequelPass instanceof org.broadinstitute.gpinformatics.mercury.boundary.DirectedPass) {

            org.broadinstitute.gpinformatics.mercury.boundary.DirectedPass sequelDirectedPass =
                    (org.broadinstitute.gpinformatics.mercury.boundary.DirectedPass) sequelPass;
...
//            directedPass.setExomeExpress(sequelDirectedPass.isExomeExpress());
        ...
        else if (sequelPass instanceof org.broadinstitute.gpinformatics.mercury.boundary.RNASeqPass) {

            org.broadinstitute.gpinformatics.mercury.boundary.RNASeqPass sequelRNASeqPass =
                    (org.broadinstitute.gpinformatics.mercury.boundary.RNASeqPass) sequelPass;
...
//        fundingInformation.setGspPriceItem(squidify(sequelPass.getFundingInformation().getGspPriceItem()));
    ...
    private static SampleList squidify(org.broadinstitute.gpinformatics.mercury.boundary.SampleList sequelSampleList) {
        ...
        for (org.broadinstitute.gpinformatics.mercury.boundary.Sample sequelSample : sequelSampleList.getSample()) {
    ...
    private static SquidPersonList squidify(org.broadinstitute.gpinformatics.mercury.boundary.SquidPersonList personList) {
        if (personList == null)
            return null;

        SquidPersonList ret = new SquidPersonList();

        for (org.broadinstitute.gpinformatics.mercury.boundary.SquidPerson person : personList.getSquidPerson()) {
    ...
    private static BSPPlatingOptions squidify(org.broadinstitute.gpinformatics.mercury.boundary.BSPPlatingOptions sequelBSPPlatingOptions) {
    ...
    /* R3_725
    private static PriceItem squidify(org.broadinstitute.gpinformatics.mercury.boundary.PriceItem sequelPriceItem) {

...
public class BarcodedTube extends LabVessel {
    ...
    public enum BarcodedTubeType {
        ...
        EppendoffFliptop15_Gates("EppendoffFliptop15_Gates", "Eppendoff Flip-top [1.5mL] (Gates)"),
        EppendoffFliptop20("EppendoffFliptop20", "Eppendoff Flip-top [2.0mL]"),
        EppendoffScrewcap15("EppendoffScrewcap15", "Eppendoff Screw cap [1.5mL]"),
        EppendoffScrewcap20("EppendoffScrewcap20", "Eppendoff Screw cap [2.0mL]"),

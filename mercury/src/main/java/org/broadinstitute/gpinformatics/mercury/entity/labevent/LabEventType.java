...
public enum LabEventType {
    ...
    // Preflight
    PREFLIGHT_CLEANUP ("PreFlightCleanup", true, true, SystemOfRecord.SQUID, false, false),
    PREFLIGHT_PICO_SETUP ("PreflightPicoSetup", true, true, SystemOfRecord.SQUID, false, false),
    PREFLIGHT_NORMALIZATION("PreflightNormalization", true, true, SystemOfRecord.SQUID, false, false),
    ...
    COVARIS_LOADED("CovarisLoaded", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    POST_SHEARING_TRANSFER_CLEANUP("PostShearingTransferCleanup", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    SHEARING_QC ("ShearingQC", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),

    // Library construction
    END_REPAIR ("EndRepair", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    POST_END_REPAIR_THERMO_CYCLER_LOADED("PostEndRepairThermoCyclerLoaded", false, true, SystemOfRecord.SQUID, false,
                                                false),
    END_REPAIR_CLEANUP ("EndRepairCleanup", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    A_BASE ("ABase", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    POST_ABASE_THERMO_CYCLER_LOADED("PostAbaseThermoCyclerLoaded", false, true, SystemOfRecord.SQUID, false, false),
    A_BASE_CLEANUP ("ABaseCleanup", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    INDEXED_ADAPTER_LIGATION ("IndexedAdapterLigation", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    POST_INDEXED_ADAPTER_LIGATION_THERMO_CYCLER_LOADED("PostIndexedAdapterLigationThermoCyclerLoaded", true, true, SystemOfRecord.SQUID, false,
                                                              false),
    ADAPTER_LIGATION_CLEANUP ("AdapterLigationCleanup", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    ...
    POND_ENRICHMENT ("PondEnrichment", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    ...
    POST_POND_ENRICHMENT_THERMO_CYCLER_LOADED("PostPondEnrichmentThermoCyclerLoaded", true, true, SystemOfRecord.SQUID, false,
                                                     false),
    POND_ENRICHMENT_CLEANUP ("HybSelPondEnrichmentCleanup", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    POND_REGISTRATION ("PondRegistration", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    POND_PICO("PondPico", false, true, SystemOfRecord.SQUID, false, false),

    // Hybrid Selection
    PRE_SELECTION_POOL ("PreSelectionPool", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    HYBRIDIZATION ("Hybridization", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    ...
    BAIT_ADDITION ("BaitAddition", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    BEAD_ADDITION ("BeadAddition", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    AP_WASH ("APWash", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    GS_WASH_1 ("GSWash1", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    GS_WASH_2 ("GSWash2", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    GS_WASH_3 ("GSWash3", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    GS_WASH_4 ("GSWash4", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    GS_WASH_5 ("GSWash5", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    GS_WASH_6 ("GSWash6", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    CATCH_ENRICHMENT_SETUP ("CatchEnrichmentSetup", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, true),
    POST_CATCH_ENRICHMENT_SETUP_THERMO_CYCLER_LOADED ("PostCatchEnrichmentSetupThermoCyclerLoaded", true, true, SystemOfRecord.SQUID, false,
                                                             false),
    CATCH_ENRICHMENT_CLEANUP ("CatchEnrichmentCleanup", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    NORMALIZED_CATCH_REGISTRATION ("NormalizedCatchRegistration", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    CATCH_PICO ("CatchPico", false, true, SystemOfRecord.SQUID, false, false),

    // QTP
    POOLING_TRANSFER ("PoolingTransfer", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    ECO_TRANSFER ("EcoTransfer", false, true, SystemOfRecord.SQUID, false, false),
    NORMALIZATION_TRANSFER ("NormalizationTransfer", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    DENATURE_TRANSFER ("DenatureTransfer", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    STRIP_TUBE_B_TRANSFER ("StripTubeBTransfer", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    FLOWCELL_TRANSFER ("FlowcellTransfer", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
    FLOWCELL_LOADED ("FlowcellLoaded", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false, false),
     ...
     */
    SHEARING_BUCKET("ShearingBucket", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, false),

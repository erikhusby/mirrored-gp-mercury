...
public enum LabEventType {
    ...
    // Shearing
    SHEARING_TRANSFER("ShearingTransfer", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    PLATING_TO_SHEARING_TUBES("PlatingToShearingTubes", false, true, SystemOfRecord.SQUID, false,
            PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    COVARIS_LOADED("CovarisLoaded", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    POST_SHEARING_TRANSFER_CLEANUP("PostShearingTransferCleanup", false, true, SystemOfRecord.SQUID, false,
            PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    SHEARING_QC("ShearingQC", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),

    // Library construction
    END_REPAIR("EndRepair", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    ...
    END_REPAIR_CLEANUP("EndRepairCleanup", true, true, SystemOfRecord.SQUID, false,
            PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    A_BASE("ABase", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    POST_ABASE_THERMO_CYCLER_LOADED("PostAbaseThermoCyclerLoaded", false, true, SystemOfRecord.SQUID, false,
            PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    A_BASE_CLEANUP("ABaseCleanup", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    ...
    WGS_ADAPTER_LIGATION_CLEANUP("WGSAdapterLigationCleanup", false, true, SystemOfRecord.SQUID, false,
            PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    POND_ENRICHMENT("PondEnrichment", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.PCR),
    ...
    POND_REGISTRATION("PondRegistration", false, true, SystemOfRecord.SQUID, false,
            PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    POND_PICO("PondPico", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),

    // Hybrid Selection
    PRE_SELECTION_POOL("PreSelectionPool", false, true, SystemOfRecord.SQUID, false,
            PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    HYBRIDIZATION("Hybridization", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    POST_HYBRIDIZATION_THERMO_CYCLER_LOADED("PostHybridizationThermoCyclerLoaded", false, true, SystemOfRecord.SQUID, false,
            PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    BAIT_SETUP("BaitSetup", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE), // todo jmt change to BOTH
    BAIT_ADDITION("BaitAddition", true, false, SystemOfRecord.SQUID, false, PlasticToValidate.TARGET, PipelineTransformation.NONE),
    BEAD_ADDITION("BeadAddition", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    AP_WASH("APWash", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    GS_WASH_1("GSWash1", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    GS_WASH_2("GSWash2", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    GS_WASH_3("GSWash3", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    GS_WASH_4("GSWash4", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    GS_WASH_5("GSWash5", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    GS_WASH_6("GSWash6", true, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    ...
    CATCH_PICO("CatchPico", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),

    // QTP
    POOLING_TRANSFER("PoolingTransfer", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),
    ECO_TRANSFER("EcoTransfer", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE, PipelineTransformation.NONE),

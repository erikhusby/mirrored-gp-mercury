...
public enum LabEventType {
    ...
    // Shearing
    SHEARING_TRANSFER("ShearingTransfer", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    PLATING_TO_SHEARING_TUBES("PlatingToShearingTubes", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                                     PlasticToValidate.SOURCE),
    COVARIS_LOADED("CovarisLoaded", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    POST_SHEARING_TRANSFER_CLEANUP("PostShearingTransferCleanup", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                                          PlasticToValidate.SOURCE),
    SHEARING_QC ("ShearingQC", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),

    // Library construction
    END_REPAIR ("EndRepair", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    POST_END_REPAIR_THERMO_CYCLER_LOADED("PostEndRepairThermoCyclerLoaded", false, true, SystemOfRecord.SQUID, false,
                                                PlasticToValidate.SOURCE),
    END_REPAIR_CLEANUP ("EndRepairCleanup", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                               PlasticToValidate.SOURCE),
    A_BASE ("ABase", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    POST_ABASE_THERMO_CYCLER_LOADED("PostAbaseThermoCyclerLoaded", false, true, SystemOfRecord.SQUID, false,
                                           PlasticToValidate.SOURCE),
    A_BASE_CLEANUP ("ABaseCleanup", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    INDEXED_ADAPTER_LIGATION ("IndexedAdapterLigation", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false,
    ...
    POST_INDEXED_ADAPTER_LIGATION_THERMO_CYCLER_LOADED("PostIndexedAdapterLigationThermoCyclerLoaded", true, true, SystemOfRecord.SQUID, false,
                                                              PlasticToValidate.SOURCE),
    ADAPTER_LIGATION_CLEANUP ("AdapterLigationCleanup", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                                     PlasticToValidate.SOURCE),
    ...
    WGS_ADAPTER_LIGATION_CLEANUP ("WGSAdapterLigationCleanup", false, true, SystemOfRecord.SQUID, false,
                                         PlasticToValidate.SOURCE),
    POND_ENRICHMENT ("PondEnrichment", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    ...
    POST_POND_ENRICHMENT_THERMO_CYCLER_LOADED("PostPondEnrichmentThermoCyclerLoaded", true, true, SystemOfRecord.SQUID, false,
                                                     PlasticToValidate.SOURCE),
    POND_ENRICHMENT_CLEANUP ("HybSelPondEnrichmentCleanup", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                                    PlasticToValidate.SOURCE),
    POND_REGISTRATION ("PondRegistration", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                              PlasticToValidate.SOURCE),
    POND_PICO("PondPico", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE),

    // Hybrid Selection
    PRE_SELECTION_POOL ("PreSelectionPool", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                               PlasticToValidate.SOURCE),
    HYBRIDIZATION ("Hybridization", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    ...
    BAIT_ADDITION ("BaitAddition", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.TARGET),
    BEAD_ADDITION ("BeadAddition", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    AP_WASH ("APWash", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    GS_WASH_1 ("GSWash1", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    GS_WASH_2 ("GSWash2", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    GS_WASH_3 ("GSWash3", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    GS_WASH_4 ("GSWash4", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    GS_WASH_5 ("GSWash5", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    GS_WASH_6 ("GSWash6", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    CATCH_ENRICHMENT_SETUP ("CatchEnrichmentSetup", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                                   PlasticToValidate.SOURCE),
    POST_CATCH_ENRICHMENT_SETUP_THERMO_CYCLER_LOADED ("PostCatchEnrichmentSetupThermoCyclerLoaded", true, true, SystemOfRecord.SQUID, false,
                                                             PlasticToValidate.SOURCE),
    CATCH_ENRICHMENT_CLEANUP ("CatchEnrichmentCleanup", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                                     PlasticToValidate.SOURCE),
    NORMALIZED_CATCH_REGISTRATION ("NormalizedCatchRegistration", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                                          PlasticToValidate.SOURCE),
    CATCH_PICO ("CatchPico", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE),

    // QTP
    POOLING_TRANSFER ("PoolingTransfer", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
    ECO_TRANSFER ("EcoTransfer", false, true, SystemOfRecord.SQUID, false, PlasticToValidate.SOURCE),
    NORMALIZATION_TRANSFER ("NormalizationTransfer", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                                   PlasticToValidate.SOURCE),
    DENATURE_TRANSFER ("DenatureTransfer", false, true, SystemOfRecord.PRODUCT_DEPENDENT, false,
                              PlasticToValidate.SOURCE),
    STRIP_TUBE_B_TRANSFER ("StripTubeBTransfer", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false,
                                  PlasticToValidate.SOURCE),
    FLOWCELL_TRANSFER ("FlowcellTransfer", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false,
                              PlasticToValidate.SOURCE),
    FLOWCELL_LOADED ("FlowcellLoaded", true, false, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),
     ...
     */
    SHEARING_BUCKET("ShearingBucket", true, true, SystemOfRecord.PRODUCT_DEPENDENT, false, PlasticToValidate.SOURCE),

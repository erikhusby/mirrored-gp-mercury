...
public class OfflineIlluminaRunService implements IlluminaRunService, Serializable {
    ...
    public static ZimsIlluminaRun makeRun(String runName, int numLanes, int numLibraries) {
        ZimsIlluminaRun run = new ZimsIlluminaRun(runName, "Run-123", "Flowcell-123", "Sequencer 123", "Test Sequencer", "05/11/2012 17:08", (short) 1, (short) 2, (short) 3, (short) 4, (short) 5, false, "36T8B", 999.987654 );

 ...
 * but it could also be used for other kinds of re-use of {@link org.broadinstitute.gpinformatics.mercury.entity.vessel.LabVessel}.
 * 
 * Take care when deciding whether something is {@link ProjectBranchable}
 * or {@link org.broadinstitute.gpinformatics.mercury.entity.analysis.ReadBucketable}.  Sometimes users just

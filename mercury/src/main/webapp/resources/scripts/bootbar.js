    ...
    $.extend($, {
        bootbar: {
            ...
            show: function(message, options) {
                ...
                var template = $("<div class=\"alert alert-messages\"></div>");
                if (settings.dismissEnabled) {
                    template.addClass("alert-dismissable");
                    template.append("<button type=\"button\" class=\"close\" aria-hidden=\"true\">&times;</button>");
                }

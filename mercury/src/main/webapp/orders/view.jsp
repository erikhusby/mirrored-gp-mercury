...
<stripes:layout-render name="/layout.jsp" pageTitle="View Product Order: ${actionBean.editOrder.title}"
                       ...
                       businessKeyValue="${actionBean.editOrder.businessKeyList}">
...
$j(document).ready(function () {
    ...
    $j.ajax({
        url: "${ctxpath}/orders/order.action?getSummary=&productOrder=${actionBean.editOrder.businessKeyList}",
        dataType: 'json',
        success: showSummary
    });
...
function updateBspInformation(chunkOfSamples) {
    ...
    $j.ajax({
        url: "${ctxpath}/orders/order.action?getBspData=&productOrder=${actionBean.editOrder.businessKeyList}&" + sampleIdString,
        dataType: 'json',
        success: showSamples
    });
}
...
<stripes:form action="/orders/order.action" id="orderForm" class="form-horizontal">
    <stripes:hidden name="productOrder" value="${actionBean.editOrder.businessKeyList}"/>
        ...
        <c:choose>
            <c:when test="${actionBean.editOrder.draft}">
                ...
                <stripes:link title="Click to edit ${actionBean.editOrder.title}"
                    ...
                    <stripes:param name="productOrder" value="${actionBean.editOrder.businessKeyList}"/>
                </stripes:link>
                    ...
                    <c:choose>
                        <c:when test="${actionBean.abandonable}">
                            ...
                            <stripes:hidden name="selectedProductOrderBusinessKeys"
                                            value="${actionBean.editOrder.businessKeyList}"/>
                        </c:when>
                        <c:otherwise>
    ...
    <div class="controls">
        <div class="form-value">
            <c:choose>
                ...
                <c:otherwise>
                    <a target="JIRA" id="orderId" href="${actionBean.jiraUrl(actionBean.editOrder.jiraTicketKey)}"
                       class="external" target="JIRA">${actionBean.editOrder.jiraTicketKey}</a>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
                    ...
                    <c:choose>
                        <c:when test="${sample.inBspFormat}">
                            <stripes:link class="external" target="BSP_SAMPLE" title="BSP Sample"
                                          href="${actionBean.sampleSearchUrlForBspSample(sample)}">
                                ${sample.sampleName}
                            </stripes:link>
                        </c:when>
                        <c:otherwise>

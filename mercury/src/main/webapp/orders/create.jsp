...
<div class="form-horizontal span6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <stripes:text readonly="${!actionBean.editOrder.draft}" id="orderName" name="editOrder.title"
        ...
        <div class="controls">
            <div class="form-value">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a target="JIRA" href="${actionBean.jiraUrl(actionBean.editOrder.jiraTicketKey)}"
                    ...
                    <div class="form-value">
                        ...
                        <stripes:link title="Research Project"
                            ...
                            <stripes:param name="<%=ResearchProjectActionBean.RESEARCH_PROJECT_PARAMETER%>"
                                           value="${actionBean.editOrder.researchProject.businessKeyList}"/>
    ...
    <div id="numberOfLanesDiv" class="control-group"
         style="display: ${actionBean.editOrder.product.supportsNumberOfLanes ? 'block' : 'none'};">
        <stripes:label for="numberOfLanes" class="control-label">
            Number of Lanes Per Sample
        </stripes:label>
        <div class="controls">
            <stripes:text readonly="${!actionBean.editOrder.draft}" id="numberOfLanes" name="editOrder.laneCount"
                          class="defaultText"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <stripes:textarea readonly="${!actionBean.editOrder.draft}" id="comments" name="editOrder.comments"
                              class="defaultText input-xlarge textarea"
                              title="Enter a description here, including any existing GAP or SQUID Initiative/Project/Experiment."
                              cols="50" rows="3"/>
        </div>
    </div>
...
<div class="help-block span4">
    ...
    <br/>
    <br/>
    <stripes:textarea readonly="${!actionBean.allowSampleListEdit}" class="controlledText" id="samplesToAdd"
                      name="sampleList" rows="15" cols="120"/>
</div>
</stripes:form>

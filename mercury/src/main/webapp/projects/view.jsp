...
<stripes:layout-render name="/layout.jsp" pageTitle="View Research Project"
                       ...
                       businessKeyValue="${actionBean.editResearchProject.businessKeyList}">
            ...
            <div class="form-value">
                <c:if test="${actionBean.editResearchProject.parentResearchProject != null}">
                    <stripes:link beanclass="${actionBean.class.name}" event="view">
                        <stripes:param name="researchProject"
                                       value="${actionBean.editResearchProject.parentResearchProject.businessKeyList}"/>
...
<div class="tableBar" style="clear:both; margin-bottom: 10px;">
    ...
    <stripes:link title="Create product with research project ${actionBean.editResearchProject.title}"
        ...
        <stripes:param name="researchProjectKey" value="${actionBean.editResearchProject.businessKeyList}"/>
        <i class="icon-plus"></i>
...
<table id="orderList" class="table simple">
    ...
    <c:forEach items="${actionBean.editResearchProject.productOrders}" var="order">
        <tr>
            ...
            <td>
                <a class="external" target="JIRA" href="${actionBean.jiraUrl(order.jiraTicketKey)}" class="external"
                   target="JIRA">
                        ${order.jiraTicketKey}
                </a>
            </td>

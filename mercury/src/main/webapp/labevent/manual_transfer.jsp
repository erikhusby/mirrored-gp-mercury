            ...
            <c:if test="${not empty actionBean.stationEvent}">
                ...
                <c:choose>
                    <c:when test="${actionBean.stationEvent.class.simpleName == 'PlateTransferEventType'}">
                        ...
                        <stripes:text id="srcPltBcd" name="stationEvent.sourcePlate.barcode" class="clearable"
                        ...
                        <stripes:text id="dstPltBcd" name="stationEvent.plate.barcode" class="clearable"
                    ...
                    <c:when test="${actionBean.stationEvent.class.simpleName == 'ReceptacleTransferEventType'}">
                        ...
                        <stripes:text id="srcRcpBcd" name="stationEvent.sourceReceptacle.barcode" class="clearable"
                        ...
                        <input type="text" id="srcRcpVol" name="stationEvent.sourceReceptacle.volume" class="clearable"
                        ...
                        <stripes:text id="destRcpBcd" name="stationEvent.receptacle.barcode" class="clearable"
                                value="${receptacleTransfer.receptacle.barcode}"/>
                        <label for="destRcpVol">Volume</label>
                        <input type="text" id="destRcpVol" name="stationEvent.receptacle.volume" class="clearable"

...
<stripes:layout-render name="/layout.jsp" pageTitle="View Product: #{actionBean.editProduct.partNumber}"
                       ...
                       businessKeyValue="${actionBean.editProduct.businessKeyList}">
...
<div class="form-horizontal">
    ...
    <div class="view-control-group control-group">
        ...
        <div class="controls">
            <div class="form-value">${actionBean.editProduct.partNumber} (<a href="Product Descriptions.pdf">Product
                Descriptions PDF</a>)
            </div>
        </div>
    </div>
        ...
        <tr>
            <td>
                <stripes:link href="/products/product.action" event="view">
                    <stripes:param name="product" value="${addOnProduct.businessKeyList}"/>

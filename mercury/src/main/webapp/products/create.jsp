        ...
        $j(document).ready(
                function () {
                    $j("#primaryPriceItem").tokenInput(
                            "${ctxpath}/products/product.action?priceItemAutocomplete=&product=${actionBean.editProduct.businessKeyList}", {
                    ...
                    $j("#addOns").tokenInput(
                            "${ctxpath}/products/product.action?addOnsAutocomplete=&product=${actionBean.editProduct.businessKeyList}", {
                    ...
                    $j("#materialTypes").tokenInput(
                            "${ctxpath}/products/product.action?materialTypesAutocomplete=&product=${actionBean.editProduct.businessKeyList}", {
...
<div class="control-group">
    ...
    <div class="controls">
        <stripes:textarea id="inputRequirements" name="editProduct.inputRequirements"
                          class="defaultText input-xxlarge textarea"
...
<div class="control-group">
    ...
    <div class="controls">
        <stripes:select id="analysisTypeKey" name="editProduct.analysisTypeKey">
            ...
            <stripes:options-collection collection="${actionBean.analysisTypes}" label="displayName"
...
<div class="control-group">
    <stripes:label for="reagentDesignKey" class="control-label"><abbr title="aka Reagent Design">Bait
        Design</abbr></stripes:label>
    <div class="controls">
        <stripes:select id="reagentDesignKey" name="editProduct.reagentDesignKey">
            <stripes:option value="">Select One</stripes:option>
            <stripes:options-collection collection="${actionBean.reagentDesigns}" label="displayName"
                                        value="businessKeyList"/>
        </stripes:select>
    </div>
</div>
...
<security:authorizeBlock roles="<%=new String[] {DB.Role.Developer.name}%>">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <stripes:checkbox id="useAutomatedBilling" name="editProduct.useAutomatedBilling"
                              onchange="updateBillingRules()" style="margin-top: 10px;"/>

...
<body>
    <ui:composition template="/layout.xhtml">
        <ui:define name="title">#{productForm.creating ? 'Create Product' : 'Edit Product Detail'} </ui:define>

        <ui:define name="metadata">
            <f:metadata>
                <f:viewParam id="productParam" name="product" value="#{productForm.product}" converter="#{productConverter}" valueChangeListener="#{productConverter.updateModel}">
                    <f:event type="preValidate" listener="#{productForm.initEmptyProduct}"/>
                </f:viewParam>
            </f:metadata>
            <f:event type="preRenderView" listener="#{productForm.onPreRenderView}"/>
        </ui:define>

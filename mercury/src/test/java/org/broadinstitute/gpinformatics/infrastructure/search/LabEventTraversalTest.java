...
//        Controller.startProbeRecording(Controller.PROBE_NAME_JDBC, true);
        ...
        List<ImmutablePair<String, String>> listEventLcset = Arrays.asList(
                ...
                new ImmutablePair<>("EcoTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("NormalizationTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("DenatureTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("MiseqReagentKitLoading", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("ReagentKitToFlowcellTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("DenatureTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("DenatureToDilutionTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("DilutionToFlowcellTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("DilutionToFlowcellTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("DilutionToFlowcellTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("DilutionToFlowcellTransfer", "LCSET-6625 LCSET-6340"),
                new ImmutablePair<>("DilutionToFlowcellTransfer", "LCSET-6625 LCSET-6340"),

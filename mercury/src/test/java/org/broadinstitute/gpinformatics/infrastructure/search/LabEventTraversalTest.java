...
//        Controller.startProbeRecording(Controller.PROBE_NAME_JDBC, true);
        ...
        List<ImmutablePair<String, List<String>>> listEventLcset = Arrays.asList(
                ...
                new ImmutablePair<>("EcoTransfer", val6625),
                new ImmutablePair<>("NormalizationTransfer", val6625),
                new ImmutablePair<>("DenatureTransfer", val6625),
                new ImmutablePair<>("MiseqReagentKitLoading", val6625),
                new ImmutablePair<>("ReagentKitToFlowcellTransfer", val6625),
                new ImmutablePair<>("DenatureTransfer", val6625),
                new ImmutablePair<>("DenatureToDilutionTransfer", val6625),
                new ImmutablePair<>("DilutionToFlowcellTransfer", val6625),
                new ImmutablePair<>("DilutionToFlowcellTransfer", val6625),
                new ImmutablePair<>("DilutionToFlowcellTransfer", val6625),
                new ImmutablePair<>("DilutionToFlowcellTransfer", val6625),
                new ImmutablePair<>("DilutionToFlowcellTransfer", val6625),

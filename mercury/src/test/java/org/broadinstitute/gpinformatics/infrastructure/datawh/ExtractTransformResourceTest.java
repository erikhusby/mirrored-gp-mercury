...
public class ExtractTransformResourceTest extends RestServiceContainerTest {
    ...
    public void testIncrementalAndBackup(@ArquillianResource URL baseUrl) {
        ...
        Assert.assertEquals(response.getClientResponseStatus(), ClientResponse.Status.ACCEPTED);
        ...
        Assert.assertEquals(response.getClientResponseStatus(), ClientResponse.Status.NO_CONTENT);

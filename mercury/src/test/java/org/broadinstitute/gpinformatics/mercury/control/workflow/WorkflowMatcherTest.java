...
//        bucketExtractions.setWorkflowQualifier("??");
        ...
        Assert.assertEquals(labEvent.getLabEventType(), LabEventType.DNA_EXTRACTION_BUCKET);
        ...
        Assert.assertEquals(labEvent1.getWorkflowQualifier(), "Reagents");

        Assert.assertEquals(workflowEvents.get(2).getLabEvents().size(), 1);
        LabEvent labEvent2 = workflowEvents.get(2).getLabEvents().get(0);
        Assert.assertEquals(labEvent2.getLabEventType(), LabEventType.PREP);
        Assert.assertEquals(labEvent2.getWorkflowQualifier(), "Disinfect");

...
public class PicoPlatingJaxbBuilder {
    ...
    public PicoPlatingJaxbBuilder invoke() {
        ...
        BettaLimsMessageTestFactory.addMessage(messageList, bettaLimsMessageTestFactory, picoPlatingBucket);
        ...
        BettaLimsMessageTestFactory.addMessage(messageList, bettaLimsMessageTestFactory, picoPlatingQc);
        ...
        BettaLimsMessageTestFactory.addMessage(messageList, bettaLimsMessageTestFactory, picoPlatingSetup1);
        ...
        BettaLimsMessageTestFactory.addMessage(messageList, bettaLimsMessageTestFactory, picoPlatingSetup2);
        ...
        BettaLimsMessageTestFactory.addMessage(messageList, bettaLimsMessageTestFactory, picoPlatingSetup3);
        ...
        BettaLimsMessageTestFactory.addMessage(messageList, bettaLimsMessageTestFactory, picoPlatingSetup4);
        ...
        BettaLimsMessageTestFactory.addMessage(messageList, bettaLimsMessageTestFactory, picoPlatingNormalizaion);
        ...
        BettaLimsMessageTestFactory.addMessage(messageList, bettaLimsMessageTestFactory, picoPlatingPostNormSetup);

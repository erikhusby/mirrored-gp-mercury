...
//                .addAsManifestResource(EmptyAsset.INSTANCE, "beans.weldonly.xml")
//                .add(new StringAsset(BEANS_XML), "beans.weldonly.xml")
//                .addAsManifestResource(new StringAsset(BEANS_XML), "beans.weldonly.xml")
//                .add(new StringAsset(BEANS_XML), "WEB-INF/beans.weldonly.xml")
...
//                .add(new StringAsset(BEANS_XML), "beans.weldonly.xml")
//                .addAsManifestResource(new StringAsset(BEANS_XML), "beans.weldonly.xml")
//                .addAsWebInfResource(new StringAsset(BEANS_XML), "beans.weldonly.xml")
                .add(EmptyAsset.INSTANCE, "addedAsset.asset")
                .add(EmptyAsset.INSTANCE, "WEB-INF/web-inf.asset")
                .addAsResource(EmptyAsset.INSTANCE, "asResource.asset")
                .addAsManifestResource(EmptyAsset.INSTANCE, "asManifestResource.asset")

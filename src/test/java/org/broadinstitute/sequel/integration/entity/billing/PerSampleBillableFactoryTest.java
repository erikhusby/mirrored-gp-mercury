...
import org.broadinstitute.sequel.entity.billing.*;
...
public class PerSampleBillableFactoryTest extends ContainerTest {
     ...
     *
     * plan1 and plan2 should have different {@link org.broadinstitute.sequel.entity.billing.Quote}s.
     * @param plan1
     * @param plan2
    ...
    private ProjectPlan createProjectPlan(String projectName,
        ...
        org.broadinstitute.sequel.entity.billing.Quote quote = new org.broadinstitute.sequel.entity.billing.Quote(quoteAlphanumericId,
     ...
     * and different {@link org.broadinstitute.sequel.entity.billing.Quote}s will be billed properly.
     * 
     * In particular, this test is supposed to verify that
     * if you have 12 {@link StartingSample}s for one
     * {@link org.broadinstitute.sequel.entity.billing.Quote} and 12 other {@link StartingSample}s from
     * a different {@link org.broadinstitute.sequel.entity.billing.Quote} comingled on a plate and

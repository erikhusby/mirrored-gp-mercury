...
/**
 * Interface for connection parameter or service producers, allowing for instances specified with the
 ...
 *
 * @param <T> The type of the connection parameters / service to be produced.
 *
 */

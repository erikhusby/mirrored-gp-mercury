package org.broadinstitute.sequel.control.billing;

import org.broadinstitute.sequel.entity.billing.Invoice;
import org.broadinstitute.sequel.entity.billing.Priceable;

/**
 * Why do we have {@link org.broadinstitute.sequel.entity.billing.Priceable#getInvoice()}
 ...
 * using {@link org.broadinstitute.sequel.entity.sample.SampleSheet sample sheets}
 * to guess at which {@link org.broadinstitute.sequel.entity.project.Project}s are relevant,
 * and therefore which quotes might be applied
 * (see {@link org.broadinstitute.sequel.entity.project.Project#getAvailableQuotes()

...
$AS_INSTALL/bin/asadmin create-auth-realm \
    --property jaas-context=crowdCustomRealm:crowd.server.url="https\://crowd.broadinstitute.org\:8443/crowd":application.name=sequel:application.password=fsR7n3Iq:flatRoles=true \

...
/**
 * Singleton core class of Mercury configuration based from YAML files.  The two {@link java.util.Map}s in this class contain:
 * <ol>
...
public class MercuryConfiguration {
    ...
    /**
     * Utility method to check for existence of properties on an {@link org.broadinstitute.gpinformatics.infrastructure.deployment.AbstractConfig}-derived bean and wrap a slew of
    ...
    /**
     * Utility method to create a new instance of the specified {@link org.broadinstitute.gpinformatics.infrastructure.deployment.AbstractConfig}-derived class.
     *
     * @param clazz The class extending {@link org.broadinstitute.gpinformatics.infrastructure.deployment.AbstractConfig} of which this method should create a new instance.
     *
